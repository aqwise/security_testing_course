      ...
      <div className="space-y-8 mt-8">
        ...
        <div className="flex items-start p-4 border-l-4 border-purple-500 bg-purple-500/10 rounded-r-md">
          ...
          <div>
            ...
            <P>
              <strong>Функция:</strong> Purple Team – это не столько отдельная команда, сколько функциональный подход, направленный на максимальное усиление взаимодействия и обмена знаниями между Red Team и Blue Team. Цель – оптимизировать защитные возможности организации. Учения Purple Team часто включают выполнение Red Team конкретных сценариев атак, в то время как Blue Team пытается их обнаружить и отразить, при этом обе стороны поддерживают открытую коммуникацию и обмениваются информацией в режиме, близком к реальному времени.
            </P>
            <P>
