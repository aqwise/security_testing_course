      ...
      <div className="space-y-8 mt-8">
        ...
        <div className="flex items-start p-4 border-l-4 border-blue-500 bg-blue-500/10 rounded-r-md">
          ...
          <div>
            ...
            <P>
              <strong>Функция:</strong> Blue Team отвечает за проектирование, внедрение, эксплуатацию и мониторинг средств защиты организации. В их задачи входит настройка и управление межсетевыми экранами (Firewalls), системами обнаружения и предотвращения вторжений (IDS/IPS), системами управления информацией и событиями безопасности (SIEM), средствами защиты конечных точек (Endpoint Protection), системами контроля доступа, а также реагирование на инциденты безопасности.
            </P>
            <P>
