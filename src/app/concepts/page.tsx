...
export default function ConceptsPage() {
  return (
    <ContentPageLayout
      ...
      imageAlt="Cybersecurity team collaboration"
      ...
      <div className="space-y-8 mt-8">
        <div className="flex items-start p-4 border-l-4 border-red-500 bg-red-500/10 rounded-r-md">
          ...
          <div>
            ...
            <P>
              Основная задача Red Team – имитировать действия реальных злоумышленников для выявления уязвимостей в системах защиты организации, тестирования эффективности средств обнаружения и реагирования, а также оценки общей готовности к атакам. Они используют методы этичного хакинга, проводят тесты на проникновение и эмулируют тактики, техники и процедуры (TTPs) известных атакующих групп.
            </P>
            <P>
              <strong>Вклад в предотвращение:</strong> Red Team напрямую не предотвращает атаки во время своих операций; их цель – успешно их провести в контролируемой среде. Однако, их деятельность имеет решающее значение для обеспечения предотвращения. Обнаруживая и эксплуатируя уязвимости до того, как это сделают реальные злоумышленники, Red Team предоставляет критически важную информацию. Эти данные позволяют организации принять превентивные меры. Таким образом, Red Team выявляет, что необходимо предотвращать.
            </P>
          </div>
        </div>
        ...
        <div className="flex items-start p-4 border-l-4 border-blue-500 bg-blue-500/10 rounded-r-md">
          ...
          <div>
            ...
            <P>
              Blue Team отвечает за проектирование, внедрение, эксплуатацию и мониторинг средств защиты организации. В их задачи входит настройка и управление межсетевыми экранами, системами обнаружения и предотвращения вторжений, SIEM, средствами защиты конечных точек, а также реагирование на инциденты.
            </P>
            <P>
              <strong>Вклад в предотвращение:</strong> Blue Team находится на переднем крае предотвращения атак. Именно они внедряют и поддерживают технические и административные меры, направленные на блокирование вредоносной активности. Они реализуют как предотвращать атаки.
            </P>
          </div>
        </div>
        ...
        <div className="flex items-start p-4 border-l-4 border-purple-500 bg-purple-500/10 rounded-r-md">
          ...
          <div>
            ...
            <P>
              Purple Team – это функциональный подход, направленный на максимальное усиление взаимодействия и обмена знаниями между Red Team и Blue Team. Цель – оптимизировать защитные возможности организации.
            </P>
            <P>
              <strong>Вклад в предотвращение:</strong> Purple Teaming напрямую способствует улучшению предотвращения за счет оптимизации всего цикла безопасности. Он гарантирует, что выводы Red Team эффективно преобразуются в конкретные, действенные улучшения для Blue Team, что ведет к созданию более надежной и эффективной общей стратегии предотвращения. Purple Team оптимизирует цикл предотвращения и обнаружения.
            </P>
          </div>
        </div>
      </div>
