              ...
              <AccordionContent className="pt-4">
                ...
                <Card className="my-6 border-primary/50">
                  ...
                  <CardContent>
                    ...
                    <P>Для более глубокого изучения SQL-инъекций, включая теорию и другие методы эксплуатации, обратитесь к <Link href="/guidelines/module-1/lesson-4" className={LinkStyle}>Уроку 1.4: SQL-инъекции – Практикум</Link>.</P>
                    <P><strong>Среда и Задания:</strong></P>
                    <Ul items={[
