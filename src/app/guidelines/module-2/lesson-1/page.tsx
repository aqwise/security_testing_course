...
export default function Module2Lesson1Page() {
  return (
    ...
    >
      ...
      <P>
        Эта таблица наглядно демонстрирует различия между белыми и черными списками, опираясь на определения из WAHH2 и примеры обхода из <Link href="#source-17" className={LinkStyle}><sup className="align-super text-xs">17</sup></Link> и<Link href="#source-18" className={LinkStyle}><sup className="align-super text-xs">18</sup></Link>. Она служит кратким руководством для понимания, почему белый список является предпочтительной стратегией безопасности, напрямую поддерживая основную идею урока по обработке ввода.
      </P>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell>A07: Identification and Authentication Failures <Link href="#source-7" className={LinkStyle}><sup className="align-super text-xs">7</sup></Link></TableCell>
            ...
            <TableRow>
              ...
              <TableCell>A05: Security Misconfiguration (для флагов); A02: Cryptographic Failures (если токены слабые/предсказуемые<Link href="#source-9" className={LinkStyle}><sup className="align-super text-xs">9</sup></Link>)</TableCell>
            ...
            <TableRow>
              ...
              <TableCell>A01: Broken Access Control <Link href="#source-11" className={LinkStyle}><sup className="align-super text-xs">11</sup></Link></TableCell>
            ...
            <TableRow>
              ...
              <TableCell>A03: Injection <Link href="#source-8" className={LinkStyle}><sup className="align-super text-xs">8</sup></Link></TableCell>
            ...
            <TableRow>
              ...
              <TableCell>A01: Broken Access Control (если доступ к неавторизованным файлам); A03: Injection (если ведет к RCE<Link href="#source-22" className={LinkStyle}><sup className="align-super text-xs">22</sup></Link>)</TableCell>
              <TableCell>1.3 Обработка Пользовательского Ввода</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Детализированные Сообщения об Ошибках</TableCell>
              <TableCell>Утечка SQL-ошибки в Juice Shop</TableCell>
              <TableCell>A05: Security Misconfiguration (Утечка информации – форма неверной конфигурации<Link href="#source-25" className={LinkStyle}><sup className="align-super text-xs">25</sup></Link>)</TableCell>
            ...
            <TableRow>
              ...
              <TableCell>A05: Security Misconfiguration <Link href="#source-32" className={LinkStyle}><sup className="align-super text-xs">32</sup></Link></TableCell>
