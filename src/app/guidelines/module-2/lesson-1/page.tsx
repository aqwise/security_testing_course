...
export default function Module2Lesson1Page() {
  return (
    ...
    >
      <H3>1.1 Введение в Основные Механизмы Защиты</H3>
      <P>
      ...
      <H3>1.2 Обработка Доступа Пользователя</H3>
      <P>
      ...
      <H3>1.2.2 Управление Сессиями</H3>
      <P>
      ...
      <H3>1.2.3 Контроль Доступа (Авторизация)</H3>
      <P>
      ...
      <H3>1.3 Обработка Пользовательского Ввода: Поле Мин для Уязвимостей</H3>
      <P>
      ...
      <H3>1.3.1 Повсеместность Пользовательского Ввода и Присущие Риски (из WAHH2 1.3.1)</H3>
      <P>
      ...
      <H3>1.3.2 Стратегии Валидации: Белые Списки, Черные Списки, Граничные Проверки</H3>
      <P>
      ...
      <H3>1.3.3 Каноникализация: Противодействие Техникам Уклонения (из WAHH2 1.3.4)</H3>
      <P>
      ...
      <H3>1.3.4 Распространенные Атаки на Основе Ввода и Практическая Эксплуатация</H3>
      <P>
      ...
      <H3>1.4 Реакция на Действия Злоумышленника: Обнаружение и Ответ</H3>
      <P>
      ...
      <H3>1.4.1 Безопасная Обработка Ошибок: Избежание Утечки Информации (из WAHH2 1.4.1)</H3>
      <P>
      ...
      <H3>1.4.2 Ведение Аудиторских Логов: Инструментарий Следователя (из WAHH2 1.4.2)</H3>
      <P>
      ...
      <H3>1.4.3 Оповещение и Стратегии Активного Реагирования (из WAHH2 1.4.3)</H3>
      <P>
        Система должна предусматривать механизмы оповещения администраторов о подозрительной активности или обнаруженных атаках в реальном времени. Адекватная реакция на атаки может включать временную блокировку IP-адресов, с которых исходит атака, принудительное завершение сессий подозрительных пользователей или активацию более строгих режимов безопасности [WAHH2 1.4.3]. В реальных сценариях это часто реализуется с помощью WAF (Web Application Firewall), IDS/IPS (Intrusion Detection/Prevention System) или SIEM (Security Information and Event Management) систем. Оповещение и активное реагирование переводят безопасность из чисто пассивного состояния в более проактивное, позволяя вмешаться до того, как будет нанесен значительный ущерб. Хотя данный урок не предполагает настройку систем оповещения, важно понимать, что эффективные логи (см. 1.4.2), такие как логи PHPIDS в DVWA 29, являются основой для таких систем.
      </P>

      <H3>1.5 Безопасное Управление Приложением (из WAHH2 1.5)</H3>
      <P>
      ...
      <H3>1.6 Заключение: Построение Устойчивой Защиты</H3>
      <P>
      ...
      <P>
        Эта таблица обеспечивает важное связующее звено между конкретными уязвимостями и механизмами WAHH2, обсуждаемыми в уроке, и более широкими, признанными в отрасли рисками OWASP Top 10. Она помогает учащимся контекстуализировать свои знания и понять реальную значимость этих проблем. Многие категории OWASP Top 10 не являются изолированными, а часто являются результатом сбоев в одном или нескольких фундаментальных механизмах защиты. Например, A01 (Broken Access Control) может проявляться как IDOR (сбой в 1.2.3) или LFI (сбой в 1.3, приводящий к несанкционированному доступу к файлам). Это подчеркивает, что "отклонения от идеала", упомянутые в WAHH2, – это именно то, что часто описывают категории OWASP Top 10.
      </P>
