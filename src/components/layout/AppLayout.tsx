...
import { FileText, ShieldCheck, PanelLeft } from 'lucide-react';
...
// Inner sidebar content that uses useSidebar hook
...
function AppLayoutClient({ children }: { children: ReactNode }) {
  ...
  // For login page, render fullscreen without any wrappers
  if (pathname === '/login') {
    return <>{children}</>;
  }
