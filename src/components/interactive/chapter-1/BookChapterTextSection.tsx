...
export function BookChapterTextSection() {
  ...
  const [textForSpeech, setTextForSpeech] = React.useState('');
  ...
  React.useEffect(() => {
    if (articleRef.current) {
      ...
      function extractText(nodes: NodeListOf<ChildNode>) {
        let tempText = "";
        nodes.forEach(node => {
          if (node.nodeType === Node.ELEMENT_NODE) {
            const element = node as HTMLElement;
            // Исключаем подписи к рисункам и содержимое blockquote, если не хотим их озвучивать
            if (element.tagName.toLowerCase() === 'figure' || element.tagName.toLowerCase() === 'blockquote') {
              return; 
            }
            // Для заголовков добавляем точку в конце для лучшей паузы
      ...
      content = extractText(childNodes);
      setTextForSpeech(content.replace(/\s+/g, ' ').trim());
    }
  }, []);
  ...
  return (
    <>
      <TextToSpeechPlayer textToSpeak={textForSpeech} className="mb-6 sticky top-16 z-20 backdrop-blur-sm bg-background/80 -mx-4 -mt-4 p-4 border-b" />
      <article ref={articleRef} className="prose prose-lg mx-auto max-w-3xl py-8 text-foreground dark:prose-invert dark:text-foreground">
        <H2>(Не)безопасность веб-приложений</H2>
      <P>
      ...
      <H3>Распространенные функции веб-приложений</H3>
      <P>
      ...
      <H3>Преимущества веб-приложений</H3>
      <P>
      ...
      <H3>Безопасность веб-приложений</H3>
      <P>
      ...
      <H3>Основная проблема безопасности: пользователи могут отправлять произвольные входные данные</H3>
      <P>
      ...
      <H3>Ключевые факторы проблемы</H3>
      <P>
      ...
      <P><strong>Недостаточный уровень осведомленности о безопасности</strong></P>
      <P>
      ...
      <P><strong>Разработка на заказ</strong></P>
      <P>
      ...
      <P><strong>Обманчивая простота</strong></P>
      <P>
      ...
      <P><strong>Быстро меняющийся профиль угроз</strong></P>
      <P>
      ...
      <P><strong>Ограничения ресурсов и времени</strong></P>
      <P>
      ...
      <P><strong>Чрезмерно расширенные технологии</strong></P>
      <P>
      ...
      <P><strong>Растущие требования к функциональности</strong></P>
      <P>
      ...
      <H3>Новый периметр безопасности</H3>
      <P>
      ...
      <H3>Будущее безопасности веб-приложений</H3>
      <P>
