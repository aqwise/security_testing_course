...
export function BookChapterTextSection() {
  return (
    <article className="prose prose-lg mx-auto max-w-3xl py-8 text-foreground dark:prose-invert dark:text-foreground">
      ...
      <div className="my-6 text-center">
        <Image
          src="https://placehold.co/600x300.png" // Placeholder for Figure 1-1
          alt="Рисунок 1-1: Традиционный веб-сайт, содержащий статическую информацию"
          width={600}
          height={300}
      ...
      <div className="my-6 text-center">
        <Image
          src="https://placehold.co/600x300.png" // Placeholder for Figure 1-2
          alt="Рисунок 1-2: Типичное веб-приложение"
          width={600}
          height={300}
          className="mx-auto rounded-md shadow-md"
      ...
      <div className="my-8 text-center">
        <Image
          src="https://placehold.co/700x450.png" // Placeholder for Figure 1-3
          alt="Рисунок 1-3: Распространенность некоторых распространенных уязвимостей веб-приложений"
          width={700}
          height={450}
          className="mx-auto rounded-md shadow-md"
