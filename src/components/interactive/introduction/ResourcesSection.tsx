...
const resources: Resource[] = [
  ...
  },
  {
    ...
    description: 'Постоянно обновляемый центр онлайн-обучения от создателей Burp Suite. Содержит материалы по новейшим угрозам и техникам атак. (task - пройти регистрацию)',
